 ...
 * @author faber222
 */
public class OltCutoverFormDestinoSlot extends javax.swing.JFrame {

    /**
     * Creates new form OltCutoverFormDestino
     */
    public OltCutoverFormDestinoSlot() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OltCutoverFormDestinoSlot.class.getName())
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OltCutoverFormDestinoSlot().setVisible(true);
            }
        });
    }
