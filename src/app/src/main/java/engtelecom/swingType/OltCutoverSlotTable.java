...
public class OltCutoverSlotTable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jTableSlot.getColumnModel().getColumnCount() > 0) {
            jTableSlot.getColumnModel().getColumn(0).setResizable(false);
            jTableSlot.getColumnModel().getColumn(1).setResizable(false);
        }
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout
                                                ...
                                                .addComponent(jButtonOk, javax.swing.GroupLayout.PREFERRED_SIZE, 103,
