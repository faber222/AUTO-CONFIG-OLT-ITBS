 ...
 */
public class ConfigGeneratorG16 extends Config {
     ...
     */
    public ConfigGeneratorG16(final List<String> vlans, final List<String> aimProfileVlan, final String interfaceEthernet,
