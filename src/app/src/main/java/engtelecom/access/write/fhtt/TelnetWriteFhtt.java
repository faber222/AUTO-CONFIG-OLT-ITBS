...
public class TelnetWriteFhtt implements Runnable {
    ...
    public TelnetWriteFhtt(final String host, final int port, final String user, final String pwd, final String oltName) {
        this.host = host;
        this.port = port;
        this.username = user;
        this.password = pwd;
