 ...
 */
public class TelnetWrite implements Runnable {
     ...
     */
    public TelnetWrite(final String host, final int port, final String user, final String pwd, final String oltName) {
