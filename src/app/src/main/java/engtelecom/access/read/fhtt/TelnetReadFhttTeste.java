...
// FALTA IMPLEMENTAR
// FALTA IMPLEMENTAR
public class TelnetReadFhttTeste implements Runnable {
    ...
    public TelnetReadFhttTeste(String host, int port, String username, String password, String fileName) {
        this.host = host;
        this.port = port;
     ...
     */
    public void run() {
        final String prompt = "Admin(DEBUG_H)>"; // Prompt que indica o fim da saída
