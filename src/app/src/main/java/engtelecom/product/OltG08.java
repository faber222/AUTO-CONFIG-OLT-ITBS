...
import engtelecom.config.ConfigGeneratorG08;
...
public class OltG08 {
    ...
    public static boolean presentation(final Object[] options, final ImageIcon equipamentoIcon,
        ...
        do {
            ...
            final int result = JOptionPane.showOptionDialog(null, "Bem Vindo ao AUTO-CONFIG-G08!", "faber222",
    ...
    public static void getPortFromUser(final ImageIcon saidaIcon, final ImageIcon erroIcon) {
        ...
        OltG08.setPort(Integer.parseInt(port));
    }
    ...
    public static void getUserAndPwd(final ImageIcon saidaIcon, final ImageIcon erroIcon) {
        ...
        do {
            ...
            OltG08.setUser(JOptionPane.showInputDialog("Digite o usuário da OLT:"));

            // Verifica se o usuário cancelou a operação.
            if (OltG08.getUser() == null) {
                saida(saidaIcon);
                System.exit(0);
            }

            // Solicita ao usuário que insira a senha da OLT.
            OltG08.setPasswd(JOptionPane.showInputDialog("Digite a senha da OLT:"));

            // Verifica se o usuário cancelou a operação.
            if (OltG08.getPasswd() == null) {
                saida(saidaIcon);
                System.exit(0);
            }

        } while (OltG08.getPasswd() == null && OltG08.getUser() == null);
    }
    ...
    public static List<String> getVlanClient(final ImageIcon equipamentoIcon, final ImageIcon saidaIcon,
        ...
        } while (!OltG08.isValidAimVlanLineRange(input, erroIcon, range));
    ...
    public static List<String> getAimProfileLine(final ImageIcon equipamentoIcon, final ImageIcon saidaIcon,
        ...
        // Processa a entrada do usuário com base no intervalo especificado.
        if (range == 16) {
            // Se o intervalo for 16, divide a entrada e adiciona os valores à lista.
            final String[] partes = input.split("-");
            final int inicio = Integer.parseInt(partes[0]);
            final int fim = Integer.parseInt(partes[1]);
            ...
            // Se o intervalo não for 16, simplesmente divide a entrada e adiciona os
            // valores à lista.
            final String[] partes = input.split("-");
    ...
    public void start() {
        ...
        String nomeArq = "script08.txt";

        // Apresenta o diálogo inicial
        OltG08.presentation(options, equipamentoIcon, saidaIcon, erroIcon);
        ...
        final String interfaceEth = OltG08.getInterfaceEth(equipamentoIcon, saidaIcon, erroIcon, modelosInterface);
        final String modelConfiguration = OltG08.getModelConfiguration(equipamentoIcon, saidaIcon, erroIcon,
                configuracoes);
        final String defaultCpe = OltG08.getDefaultCpeType(equipamentoIcon, saidaIcon, erroIcon, defaultCpeType);
        int rangeVlan;
        int rangeAimVlan;
        int rangeAimLine;
        ...
        if (modelConfiguration.equals(configuracoes[1])) {
            ...
            rangeVlan = rangeAimVlan = 8;
            rangeAimLine = 16;
        }

        // Obtém as listas necessárias para a configuração
        final List<String> arrayVlan = OltG08.getVlanClient(equipamentoIcon, saidaIcon, erroIcon, rangeVlan);
        final List<String> arrayAimVlan = OltG08.getAimProfileVlan(equipamentoIcon, saidaIcon, erroIcon, rangeAimVlan);
        final List<String> arrayAimLine = OltG08.getAimProfileLine(equipamentoIcon, saidaIcon, erroIcon, rangeAimLine);

        // Cria um objeto ConfigGenerator para gerar o script de configuração
        final ConfigGeneratorG08 configGeneratorG08 = new ConfigGeneratorG08(arrayVlan, arrayAimVlan, interfaceEth,
                arrayAimLine,
                deviceType, modelConfiguration, configuracoes, defaultCpe, interfaceGpon, defaultCpeType);
        configGeneratorG08.createScript(nomeArq);

        OltG08.getIpFromUser(saidaIcon, erroIcon);
        OltG08.getPortFromUser(saidaIcon, erroIcon);
        OltG08.getUserAndPwd(saidaIcon, erroIcon);
