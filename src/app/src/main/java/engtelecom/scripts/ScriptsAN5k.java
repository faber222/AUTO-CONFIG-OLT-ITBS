...
public class ScriptsAN5k {
    ...
    public List<String> configProfileServMode() {
        ...
        scriptServMode.add(
                "add servmode profile index 9 name INTELBRAS_ROUTER type unicast cvlan transparent translate disable qinq disable null");
    ...
    public List<String> comandoWifi2(final String slotGpon, final String slotPortaPon, final String slotCpe, final String ssidName2,
        ...
        scriptComandoWifi.add(String.format(
                "set wifi_serv_cfg slot %s pon %s onu %s serv_no 1 wifi enable district brazil channel 0 standard %s txpower 20 frequency 2.4ghz freq_bandwidth 20mhz/40mhz",
    ...
    public List<String> comandoWifi5(final String slotGpon, final String slotPortaPon, final String slotCpe, final String ssidName5,
        ...
        scriptComandoWifi.add(String.format(
                "set wifi_serv_cfg slot %s pon %s onu %s serv_no 2 wifi enable district brazil channel 0 standard %s txpower 20 frequency 5.8ghz freq_bandwidth 80mhz",
                slotGpon, slotPortaPon, slotCpe, wifiVersion));
        return scriptComandoWifi;
    }
    ...
    public List<String> comandoOnuCapaF3() {
        ...
        scriptOnuCapa.add("modify cs onu profile name HG6145F3 eid HG6145F3");
        return scriptOnuCapa;
    }
    ...
    public List<String> comandoOnuCapaF() {
        ...
        scriptOnuCapa.add("modify cs onu profile name HG6145F eid HG6145F");
        return scriptOnuCapa;
    }
    ...
    public List<String> comandoOnuCapaD2() {
        ...
        scriptOnuCapa.add("add cs onu profile option wifi 2 end");
        scriptOnuCapa.add("modify cs onu profile name HG6145D2 eid HG6145D2");
        return scriptOnuCapa;
    }
